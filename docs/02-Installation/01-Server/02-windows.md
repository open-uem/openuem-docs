...
```(powershell)
Get-FileHash openuem-server-setup-0.4.1.exe

Algorithm       Hash                                                                   Path
---------       ----                                                                   ----
SHA256          2AD5D64CC8E0B07472AE93698882F5DD3028D25F3C2C32E9A16DA7525FDD36DC       C:\Users\doncicuto\Downloads\openuem....
```
