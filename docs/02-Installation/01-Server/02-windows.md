...
```(powershell)
Get-FileHash openuem-server-setup-0.3.0.exe

Algorithm       Hash                                                                   Path
---------       ----                                                                   ----
SHA256          D607EC1E7A5C4F3F46A4393E0FCB3D9A5B81711971CE11F732749CE0A8CFF4C2       C:\Users\doncicuto\Downloads\openuem....
```
